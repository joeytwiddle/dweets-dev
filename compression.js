...
/*
Hi Yonatan, I think your "mottled" banana is so great, we should share it on Dwitter, to complete the <https://www.dwitter.net/h/banana> collection.

I managed to compress it using MrM@_S's compressor (I think my compressor failed due to the odd character count)

```js
eval(unescape(escape`挮睩摴栽㈰〻景爨搽椽ㄷ〰㭪㵩ⴭ⽤㭸⹦楬汒散琨㤹⬨椭ㅥ㌩⩓⡴⤯㤫匨椩⨨爭愯㐩ⱓ⠳⩪⤪㜵⭃⡩⤪爬㘬㘩⥲㵪㸮㤿㈺㌰⩓⠳⩪⬮㌩ⱸ⹦楬汓瑹汥㵒⡢㴷⨨愽爭匨椪㈩⨪㠪ㄵ⤭匨椪⨸⤪⨸⨳〬截⸸⤻`.replace(/u(..)/g,"$1%")))
```

Please share your compressed banana on Dwitter!  Otherwise, wih your permission, I will post it myself.  But I think it's better if you.  :-)
*/
