...
// --- GOOD --- Golfed (by expanding the **2) and then cancelling
for(i=600;i--;x.clearRect(960-W,99+i,2*W,1))W=(600*i-i*i)**.5
s=9+T(t/5||8)**8,x.fillRect(960-500*C(2*t)-s,400-s*.4*S(70*t)-s/2,2*s,s)

// TODO: Can we perform 3 fillRects for the bat, with the middle one oscillating independently of the outer two.  (7 or more also acceptable)
